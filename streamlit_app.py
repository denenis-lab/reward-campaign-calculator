...
period_1 = col1.number_input("Срок 1", value=30, step=10, key="p1")
period_2 = col2.number_input("Срок 2", value=60, step=10, key="p2")
period_3 = col3.number_input("Срок 3", value=90, step=10, key="p3")
periods = [period_1, period_2, period_3]

st.sidebar.subheader("Cap на баланс (USD)")
col1, col2, col3 = st.sidebar.columns(3)
cap_1 = col1.number_input("Cap 1", value=500, step=100, key="c1")
cap_2 = col2.number_input("Cap 2", value=1000, step=100, key="c2")
cap_3 = col3.number_input("Cap 3", value=2000, step=100, key="c3")
